...
For a detailed analysis of secondary indexes, including MVCC handling, index-only scans, and pointer management, see [Secondary Indexes](secondary-indexes.mdx).
